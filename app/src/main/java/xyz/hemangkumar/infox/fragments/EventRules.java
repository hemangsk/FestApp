...
public class EventRules extends Fragment {
    ...
    public static EventRules newInstance(ArrayList<Event> data,int pos) {
        EventRules fragment = new EventRules();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_rules_event, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText(events.get(position).getRules());
    }
}
